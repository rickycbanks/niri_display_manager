...
QtObject {
    ...
    readonly property color borderFocus:"#7c6af0"

    // Accent / primary
    readonly property color accent:     "#7c6af0"
    readonly property color accentDim:  "#5b4cc4"
    readonly property color accentGlow: "#9d8ff5"
    ...
    readonly property color monitorSelected: "#3a3460"
    readonly property color monitorDisabled: "#1a1926"
    readonly property color monitorBorder:   "#4a4570"
    readonly property color monitorBorderSelected: "#7c6af0"
